package com.findmeby.client.db;
...
import com.findmeby.client.constant.ContactField;
...
public class SQLiteDB extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + ContactField.TABLE_NAME + " (" +
                    ...
                    ContactField.COLUMN_EMAIL + TEXT_TYPE + " )";
    ...
    public void create(Contact contact){
        ...
        values.put(ContactField.COLUMN_EMAIL, contact.getEmail());
    ...
    public Cursor retrieve(){
        ...
        String[] projection = {
                ...
                ContactField.COLUMN_EMAIL };

        // How you want the results sorted in the resulting Cursor
        String sortOrder =
                ContactField.COLUMN_EMAIL + " ASC";
